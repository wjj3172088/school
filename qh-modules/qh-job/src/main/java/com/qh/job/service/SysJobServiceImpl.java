...
import com.qh.job.mapper.SysJobMapper;
import com.qh.job.util.CronUtils;
import com.qh.job.util.ScheduleUtils;
...
public class SysJobServiceImpl extends ServiceImpl<SysJobMapper, SysJob> implements ISysJobService
{
     ...
     */
    @Override
    public IPage<SysJob> selectJobListByPage(IPage<SysJob> page, SysJob job)
    {
        return this.page(page, getQuery(job));
    }

    private QueryWrapper<SysJob> getQuery(SysJob job){
     ...
     */
    @Override
    public List<SysJob> selectJobListByAll(SysJob job){
        return this.list(getQuery(job));
    }
    ...
    public int batchTodayAddByOrg(){
        return jobMapper.batchTodayAddByOrg();
    }
}