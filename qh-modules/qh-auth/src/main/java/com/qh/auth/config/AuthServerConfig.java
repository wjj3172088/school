...
import com.qh.auth.exception.CustomWebResponseExceptionTranslator;
...
import com.qh.common.security.service.RedisClientDetailsService;
    ...
    public TokenEnhancer tokenEnhancer() {
        return (accessToken, authentication) -> {
            if (authentication.getUserAuthentication() != null) {
                ...
                additionalInformation.put(SecurityConstants.DETAILS_ORG_NAME, user.getOrgName());
