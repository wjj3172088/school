...
public interface ISysMenuService {
     ...
     * @return 菜单列表
     */
    List<FastMenu> selectFastMenuTreeAll();
     ...
     */
    void saveFastMenu(List<Long> menuIdList, Long userId);
     ...
     * @return
     */
    List<FastMenu> selectMyFastMenu(Long userId);
     ...
     * @return 结果
     */
    int updateFastMenu(SysMenu menu);
}
