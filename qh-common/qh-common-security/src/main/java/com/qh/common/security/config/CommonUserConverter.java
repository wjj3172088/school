...
public class CommonUserConverter implements UserAuthenticationConverter {
    ...
    public Authentication extractAuthentication(Map<String, ?> map) {
        if (map.containsKey(USERNAME)) {
            ...
            String orgName = (String) map.get(SecurityConstants.DETAILS_ORG_NAME);
            LoginUser user = new LoginUser(userId, username, N_A, orgId, orgName, true, true, true, true, authorities);
