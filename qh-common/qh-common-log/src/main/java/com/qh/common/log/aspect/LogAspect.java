package com.qh.common.log.aspect;
...
import com.qh.common.log.enums.BusinessStatus;
import com.qh.common.log.service.AsyncLogService;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.qh.common.log.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            //设置学校id
            operLog.setOrgId(loginUser.getOrgId());
            // 设置方法名称
